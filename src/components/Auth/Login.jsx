...
const [loading, setLoading] = useState(false);
  ...
  const handleLogin = async () => {
    try {
      ...
      const response = await fetch( `${Base_Url}api/v1/admin/signin`,   requestOptions );
  ...
  if (token) {
    navigate("/home", { replace: true });  // login page history remove
  }
}, []);
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-gray-100">
      <div className="w-[90%] md:w-[80%] lg:w-[70%] h-[85vh] bg-white rounded-3xl shadow-xl overflow-hidden flex">

        {/* LEFT SIDE */}
        <div className="w-[50%] p-10 flex flex-col justify-center bg-gradient-to-b from-yellow-200 via-white to-white">
